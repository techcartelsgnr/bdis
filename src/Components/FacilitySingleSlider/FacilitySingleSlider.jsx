...
import "../FacilitySingleSlider/facilitysingleslider.css"
...
const FacilitySingleSlider = ({
    facility // Changed from facilitysingleslider to match prop name passed from parent
}) => {
        ...
        <>
            {
                loading ? (
                    ...
                    >
                        {
                            facility.map((item, index) => ( // Changed from facilitysingleslider to facility
